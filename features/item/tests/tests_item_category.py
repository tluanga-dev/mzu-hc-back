...
class ItemCategoryModelTest(TestCase):
    @classmethod
    def setUp(self):
        self.item_category=ItemCategory.objects.create(name='Test Name', abbreviation='TN', description='Test Description')

    def test_name_label(self):
        itemcategory = ItemCategory.objects.get(id=self.item_category.id)
