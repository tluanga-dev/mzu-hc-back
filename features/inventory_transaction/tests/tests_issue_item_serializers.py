...
# from .models import  InventoryTransaction, InventoryTransactionItem, IssueItemInventoryTransaction, ItemBatch
# from .serializers import IssueItemInventoryTransactionSerializer
...
#         print('issue_transaction',issue_transaction)
        
      

#         # print('indent_transaction_from_db',indent_transaction)
#         # self.assertEqual(indent_transaction.inventory_transaction_type, InventoryTransaction.TransactionTypes.ITEM_ISSUE)
